...
View the [demo here](http://ember-pop-over.surge.sh)
...
If everything went well, you should have a date-picker that behaves like the one here: http://ember-pop-over.surge.sh
